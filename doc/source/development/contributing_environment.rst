...
In the root directory of the project run the below command to install the pre-commit tool. For more details on installing and usage of pre-commit,visit <https://pandas.pydata.org/pandas-docs/stable/development/contributing_codebase.html#pre-commit>`__
